    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gatunek', models.PositiveSmallIntegerField(choices=[(1, 'Horror'), (0, 'Inne'), (3, 'Sci-fi'), (2, 'Komedia'), (4, 'Dramat')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Film',
            fields=[
                ...
                ('dodatkowe', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='minifilmweb.dodatkoweinfo')),
            ],
        ),
        migrations.CreateModel(
            name='Ocena',
